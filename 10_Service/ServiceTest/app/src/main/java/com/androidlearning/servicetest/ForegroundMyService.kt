...
class ForegroundMyService : Service() {
    ...
    class DownloadBinder : Binder() {
        ...
        fun startDownload() {
            Log.d("ForegroundMyService", "startDownload() 执行了")
        }

        fun getProgress(): Int {
            Log.d("ForegroundMyService", "getProgress() 执行了")
            return 0
        }
    }
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d("ForegroundMyService", "onCreate() 方法执行了")
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d("ForegroundMyService", "onStartCommand() 方法执行了")
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.d("ForegroundMyService", "onDestroy() 方法执行了")
    }
}
